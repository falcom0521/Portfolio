...
export const Data = [
    {
        ...
        image: Image1,
        title: "Face Swap",
        description: "FaceSwap is a user-friendly website built with the React framework, designed to make face swapping in your photos both easy and precise.",
        url: "https://faceswap-4al6.vercel.app/"
    },
    {
        id: 2,
        image: Image2,
